...
public class Map {
	...
	public void setMap(String mapname) {
		...
		if(mapname.equals("Duel")) {
			...
			Wall w4 = new Wall(340, 475,"src/resources/xx.png");
			Wall w5 = new Wall(340, 100, "src/resources/xx.png");
			Wall w6 = new Wall(340, 350, "src/resources/xx.png");
		...
		if(mapname.equals("River")) {
			...
			kitlist.add(new Kit(650, 250));
			kitlist.add(new Kit(50,50));
			kitlist.add(new Kit(50,250));
			kitlist.add(new Kit(400, 250));
			kitlist.add(new Kit(400,50));
			kitlist.add(new Kit(475,450));
			this.DrawBoostArea("River", null, "src/resources/cloud.png");
		}
		if(mapname.equals("Forest")) {
			setP1start(100,100, 3*Math.PI/4);
			setP2start(600,500, -Math.PI/4);
			Wall w1 = new Wall(400, 388, "src/resources/xx.png");
			Wall w2 = new Wall(0,50, "src/resources/xx.png");
			Wall w3 = new Wall(150,0, "src/resources/xx.png");
			Wall w4 = new Wall(250,50, "src/resources/xx.png");
			Wall w5 = new Wall(350,70, "src/resources/xx.png");
			Wall w6 = new Wall(450,50, "src/resources/xx.png");
			Wall w7 = new Wall(550,20, "src/resources/xx.png");
			Wall w8 = new Wall(650,50, "src/resources/xx.png");			
			Wall w9 = new Wall(0,50, "src/resources/xx.png");
			Wall w10 = new Wall(150,250, "src/resources/xx.png");
			Wall w11 = new Wall(250,350, "src/resources/xx.png");
			Wall w12 = new Wall(350,250, "src/resources/xx.png");
			Wall w13 = new Wall(450,550, "src/resources/xx.png");
			Wall w14 = new Wall(550,250, "src/resources/xx.png");
			Wall w15 = new Wall(650,150, "src/resources/xx.png");
