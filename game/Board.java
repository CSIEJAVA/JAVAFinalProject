...
public class Board extends JPanel implements ActionListener{
	...
	private void initBoard() {
		...
		setFocusable(true);
		background = new Map();
		tanker = new Tank(100,100, 3*Math.PI/4,background.getwall(), background.getkit()); //start x, start y, start angle, wall
		tanker2 = new Auto(600,500, -Math.PI/4,background.getwall(), background.getkit());
